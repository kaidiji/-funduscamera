          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">
                身分證字號 / 病歷號 {activeTab === 'FUNDUS_PDF' && <span className="text-rose-500">*</span>}
              </label>
              <input
                type="text"
                value={idValue}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5">
                檢查眼別 {activeTab === 'OTHER_CAMERA' && <span className="text-rose-500">*</span>}
              </label>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">
                轉檔日期 (YYYYMMDD) {activeTab === 'OTHER_CAMERA' && <span className="text-rose-500">*</span>}
              </label>
              <input
                type="text"
                value={dateValue}
                onChange={(e) => setDateValue(e.target.value)}
                placeholder="例如：20260911"
